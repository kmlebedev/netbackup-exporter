...
// APIClient manages communication with the NetBackup Administration API API v4.0
...
func (c *APIClient) decode(v interface{}, b []byte, contentType string) (err error) {
	if strings.Contains(contentType, "application/xml") {
		...
		return nil
	} else if strings.Contains(contentType, "application/json") || strings.Contains(contentType, "application/vnd.netbackup+json") {
